...
SCORE_WEIGHTS = {
    ...
    'ebitda': 0.05,
    'gross_margin': 0.05,
    # Uncomment to add even more:
    # 'payout_ratio': 0.05,
    # 'operating_margin': 0.05,
    # 'target_mean_price': 0.05,
}
EXTRA_METRICS = [
    'dividend_yield', 'eps', 'revenue', 'free_cash_flow', 'ebitda', 'gross_margin'
    # Uncomment to add more (after adding to get_fundamentals):
    # 'payout_ratio', 'operating_margin', 'target_mean_price'
]
EXTRA_METRICS_LABELS = {
    ...
    # 'target_mean_price': 'Analyst Target'
}
...
def main():
    ...
    st.title("📈 Fundamental Analysis (Stock_Fundamental_Score2.py)")

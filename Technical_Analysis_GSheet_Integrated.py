...
def load_watchlist_from_gsheet(sheet_id: str, worksheet_name: str = None):
    ...
    creds = Credentials.from_service_account_file("streamlit-dashboard/credentials/credentials.json", scopes=scope)
...
# Replace this with your actual sheet ID and optional worksheet name
GOOGLE_SHEET_ID = "1M9Vb7SnSwAGw3Uaqrje8m7nmQHjdqKX0qLkpZiDPt8"
WATCHLIST_DF = load_watchlist_from_gsheet(GOOGLE_SHEET_ID)

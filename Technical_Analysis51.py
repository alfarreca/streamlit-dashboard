...
import plotly.graph_objects as go  # Use Plotly instead of matplotlib
...
def plot_comparison_chart(comparison_data, selected_companies):
    ...
    for company in selected_companies:
        if company in comparison_data:
            ...
            fig.add_trace(go.Scatter(x=comparison_data[company].index, y=normalized_prices, mode='lines', name=company))
    fig.update_layout(
